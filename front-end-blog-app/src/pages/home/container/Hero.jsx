...
const Hero = () => {
  return (
    <section className=' mx-auto  flex flex-col py-0 lg:flex-row lg:w-full'>
      <div className=' mt-10 lg:w-1/2 px-5'>
      ...
      <div className='hidden lg:block lg:w-1/2 w-fit h-full px-0 pl-20'>
        {/* Image */}
        <img className='w-full h-full'  src={images.HeroImage} alt=" users are reading articles" />
      </div>
    </section>
  );
};
